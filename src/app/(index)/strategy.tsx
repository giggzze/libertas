...
import { Debt, DebtWithPayments, Expense, PayoffStrategy } from "@/src/types/STT";
...
export default function StrategyScreen() {
	...
	const monthlyIncome =  currentIncome?.amount
	const totalMonthlyPayments = calculationDebts?.reduce((sum, debt) => sum + debt.minimum_payment, 0);
	...
	const recommendedPayments = calculateRecommendedPayment(calculationDebts, selectedStrategy, monthlyIncome)
