...
export default function HomeScreen() {
    ...
    const monthlyIncomeAmount = monthlyIncome?.[0]?.amount ?? 0;
    const incomeUsagePercentage = monthlyIncomeAmount > 0 ? (totalMonthlyObligations / monthlyIncomeAmount) * 100 : 0;
    const remainingIncome = monthlyIncomeAmount - totalMonthlyObligations;
...
// TODO:: Need to put this back in when we add the last insight component
