import { zincColors } from '@/constants/theme';
import React from 'react';
import { StyleSheet, TextInput as RNTextInput, TextInputProps as RNTextInputProps, TextStyle, useColorScheme, View, ViewStyle } from 'react-native';
...
const TextInput: React.FC<TextInputProps> = ({ label, error, variant = 'default', size = 'md', containerStyle, inputStyle, disabled = false, ...props }) => {
